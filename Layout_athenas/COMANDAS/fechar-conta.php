			...
			<div class="caixa">
				...
				<div class="rows">
								...
								<table class="tabela border min limpa" width="100%" cellpadding="0" cellspacing="0">
									...
									<tbody>
										<tr class="bg-branco">
											...
											<a href="" class="btn btn-verde btn-min d-inline-block">Adicionar todos</a>
											</td>
										</tr>
										<tr class="bg-branco">
											<td class="text-center">1</td>
					...
					<div class="col-12 mb-3 d-flex px-4 text-end">
						<a href="index.php?link=6" class="btn btn-verde">Fechar conta <i class="fas fa-arrow-right"></i></a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-4 d-flex">
						<div class="caixa">
							...
							<div class="p-1 px-3">
								...
								<input type="submit" class="btn btn-verde mb-1 mt-1 width-100" value="Adicionar">
							</div>
						</div>
					</div>
				</div>
