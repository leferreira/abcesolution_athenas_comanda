...
<div class="pedido ordem fechar-conta">
	<div class="rows">	
			...
			<div class="caixa">	
				...
				<div class="rows">	
					<div class="col-12 mb-3 ">	
						<div class="bg-normal">
							<div class="p-1 d-flex justify-content-space-between">
								<a href="" class="btn btn-gra-azul p-1"> Pagar tudo</a>
								<a href="" class="btn btn-gra-azul p-1"> Dividir tudo</a>
							</div>
								...
								<table class="tabela border min limpa" width="100%" cellpadding="0" cellspacing="0">
									...
									<tbody>
										<tr class="bg-branco"> 								  
											...
											<a href="javascript::" onclick="abrirModal('#dividir')" class="btn btn-gra-azul btn-min d-inline-block">Dividir</a>
											<a href="javascript::" onclick="abrirModal('#add')" class="btn btn-gra-azul btn-min d-inline-block">Adicionar</a>
											<a href="" class="btn btn-verde2 btn-min d-inline-block">Adicionar todos</a>
											</td>						  
										</tr>
										<tr class="bg-branco"> 								  
											<td class="text-center">1</td>	
					...
					<div class="col-12 mb-3 d-flex px-4 text-end">	
						<a href="index.php?link=6" class="btn btn-verde2">Fechar conta <i class="fas fa-arrow-right"></i></a>
					</div>
				</div>
			</div>
		</div>
		<div class="col-8 ordem-right">		
			<div class="caixa p-2">		
				<div class="rows">
					<div class="col-8">
						<div class="caixa">	
							<span class="d-block p-1 h5 mb-0 text-right"><b>Valor: </b>R$30,00</span>
							...
							<table class="tabela limpa" width="100%" cellpadding="0" cellspacing="0">
									...
									<tbody>
										<tr class="bg-branco"> 								  
											...
											<td class="text-right">		
											<strong class="d-block">R$ 30,00</strong>
											<a href="" class="btn btn-vermelho btn-min d-inline-block">Remover</a>
											<a href="" class="btn btn-laranja btn-min d-inline-block">Remover todos</a>
											</td>						  
										</tr>
										<tr class="bg-branco"> 								  
											<td class="text-center">1</td>	
											<td class="text-left">Refrigerante</td>							  
											<td class="text-right">		
											<strong class="d-block">R$ 30,00</strong>
											<a href="" class="btn btn-vermelho btn-min d-inline-block">Remover</a>
											<a href="" class="btn btn-laranja btn-min d-inline-block">Remover todos</a>
						...
						<div class="mt-1 caixa">
							<table class="tabela limpa" width="100%" cellpadding="0" cellspacing="0">
									<thead>
										<tr class="bg-branco"> 
											<th align="center" colspan="3">Pagamentos parciais</td>													  
										</tr>
									</thead>
									<tbody>
										<tr class="bg-branco"> 								  
											<td class="text-center">Cartão de crédito</td>
											<td class="text-center">Valor: <b>R$30,00</b></td>
											<td>	
												<a href="" class="btn btn-vermelho btn-min d-inline-block"><i class="fas fa-trash"></i></a>
											</td>						  
										</tr>
										<tr class="bg-branco"> 								  
											<td colspan="3" align="center" class="py-3">	
												<a href="index.php?link=6" class="btn btn-gra-amarelo btn-medio d-inline-block"><i class="fas fa-check"></i> Finalizar pagamento</a>
											</td>						  
										</tr>
									</tbody>
								</table>
					...
					<div class="col-4 d-flex">						
						<div class="caixa">	
							<div class="p-1 px-3">	
								<a href="" class="btn btn-azul mb-1">Dinheiro</a>
								<a href="" class="btn btn-azul mb-1">Cartão crédito</a>
								<a href="" class="btn btn-azul mb-1">Cartão débito</a>
								<a href="" class="btn btn-outline-azul mb-1">Ver mais</a>
							</div>
							<hr></hr>
							
							<div class="p-1 px-3">	
								<span class="text-label">Valor a pagar</span>
								<input type="text" class="form-campo valor" value="R$30,00">
								<input type="submit" class="btn btn-verde2 mb-1 mt-1 width-100" value="Adicionar">
							</div>
						</div>
					</div>
				</div>
