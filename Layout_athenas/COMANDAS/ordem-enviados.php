			...
			<div class="caixa">
				<div id="tabs" class="p-2">
				  <ul>
					...
					<li><a href="#tabs-2">Hanburguer</a></li>
					<li><a href="#tabs-3">Hot dog</a></li>
					<li><a href="#tabs-4">Bebidas</a></li>
					<li><a href="#tabs-5">Porções</a></li>
				  </ul>
				  <div id="tabs-1">
					<div class="rows rows2">
						<div class="col-2 d-flex mb-3">
							<div class="caixa">
								<div class="home-mesa">
									...
									<span class="tt2">R$ 30,00</span>
								<div class="botoes alt">
									<a href="" class="btn btn-gra-azul addicionar" title="Adicionar completo"><i class="fas fa-plus-circle"></i> </a>
